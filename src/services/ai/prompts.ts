...
export const buildEventAssistantPrompt = (context?: PromptContext): string => {
  ...
  lines.push('8. Estilo de respuesta: ofrece siempre un siguiente paso (reservar, ver más opciones, cambiar filtros). Evita frases como “ya te di la información”; aporta resúmenes útiles o alternativas. Si no hay resultados, sugiere acciones (otra ciudad, otro tipo de lugar, otro horario).');
  lines.push('9. Expresa todas las fechas y horas en español y con formato natural.');
  lines.push('');
